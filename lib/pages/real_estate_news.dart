...
class RealEstateNews extends StatelessWidget {
  ...
  List imgs = [
    'https://58realty.so.house/media/portfolio/%E5%B8%82%E5%9C%BA%E5%8A%A8%E6%80%81.jpg?&width=115&height=90&rmode=stretch',
  ...
  List descs = [
    '【地产市场】GTA地区高层建筑的土地购买价格是多少？土地成本占出售收入的比例有多大？最新High Rise Land Inside Report告诉您细节',
  ...
  List links = [
    'https://realtyblog.so.house/housing-market/post-3',
    'https://realtyblog.so.house/housing-market/post-3',
    'https://realtyblog.so.house/housing-market/post-3',
    'https://realtyblog.so.house/housing-market/post-3',
    'https://realtyblog.so.house/housing-market/post-3',
    ...
    Widget listSection = Flexible(
        ...
        child: GridView.count(
            ...
            children: _generateGridItems(
                context, this.imgs, this.descs, this.links)));
...
List<Container> _generateGridItems(
    BuildContext context, List imgs, List descs, List links) {
  int imgColumn =
      MediaQuery.of(context).orientation == Orientation.landscape ? 3 : 3;
  int descColumn =
      MediaQuery.of(context).orientation == Orientation.landscape ? 4 : 5;
  ...
  for (int i = 0; i < imgs.length; i++) {
    gridItems.add(Container(
      ...
      children: <Widget>[
        Expanded(
            flex: imgColumn, child: InkWell(child: GridListImgClip(imgs[i]), onTap: () {
        ...
        Expanded(
            ...
            child: Container(
                ...
                child: InkWell(
                  child: Text(StringFormat.maxLength(descs[i], 32)),
                  onTap: () {
                    Navigator.pushNamed(context, NewsDetail.routeName,
                        arguments: links[i]);
                  },
